...
Route::prefix('backend')->group(function(){
    ...
    //Multiple sites
    Route::get('/multiple-sites', [App\Http\Controllers\Backend\MultipleSitesController::class, 'getMultipleSitesPageLoad'])->name('backend.MultipleSites')->middleware(['auth','is_admin']);
    Route::get('/getMultipleSitesTableData', [App\Http\Controllers\Backend\MultipleSitesController::class, 'getMultipleSitesTableData'])->name('backend.getMultipleSitesTableData')->middleware(['auth','is_admin']);
    Route::post('/saveMultipleSitesData', [App\Http\Controllers\Backend\MultipleSitesController::class, 'saveMultipleSitesData'])->name('backend.saveMultipleSitesData')->middleware(['auth','is_admin']);
//    Route::post('/deleteProducts', [App\Http\Controllers\Backend\ProductsController::class, 'deleteProducts'])->name('backend.deleteProducts')->middleware(['auth','is_admin']);
//    Route::post('/bulkActionProducts', [App\Http\Controllers\Backend\ProductsController::class, 'bulkActionProducts'])->name('backend.bulkActionProducts')->middleware(['auth','is_admin']);
//    Route::post('/hasProductSlug', [App\Http\Controllers\Backend\ProductsController::class, 'hasProductSlug'])->name('backend.hasProductSlug')->middleware(['auth','is_admin']);
//    //Update
    Route::get('/site/{id?}', [App\Http\Controllers\Backend\MultipleSitesController::class, 'getMultipleSitesPageData'])->name('backend.site')->middleware(['auth','is_admin']);
//    Route::post('/updateProductsData', [App\Http\Controllers\Backend\ProductsController::class, 'updateProductsData'])->name('backend.updateProductsData')->middleware(['auth','is_admin']);
