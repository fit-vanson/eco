...
@section('title', __('Multiple Sites'))
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div id="list-panel" class="card-body">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="group-button">
                                            ...
                                            <button type="button" onClick="onDataViewByStatus(1)" id="viewstatus_1"
                                                    class="btn btn-theme viewstatus">{{ __('Published') }}
                                                ({{ $PublishedCount }})
                                            </button>
                                            <button type="button" onClick="onDataViewByStatus(2)" id="viewstatus_2"
                                                    class="btn btn-theme viewstatus">{{ __('Draft') }}
                                                ({{ $DraftCount }})
                                            </button>
                                        </div>
                                ...
                                <div id="tp_datalist">
                                    @include('backend.partials.multiple_sites_table')
                                </div>
                            </div>
                            <!--/Data grid/-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="title">{{ __('Site Name') }}<span
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="title">{{ __('Site Web') }}<span
                                                        class="red">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="categoryid[]" id="category_id" class="chosen-select form-control" multiple>
                                                    @foreach($categorylist as $row)
                                                        <option value="{{ $row->id }}">
                                                            {{ $row->name }}
                                                        </option>
