								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select name="offer_ad_type" id="offer_ad_type" class="chosen-select form-control">
											<option value="position1_home1">Position 1 (For Homepage 1)</option>
											<option value="position2_home1">Position 2 (For Homepage 1)</option>
											<option value="position1_home2">Position 1 (For Homepage 2)</option>
											<option value="position2_home2">Position 2 (For Homepage 2)</option>
											<option value="position1_home3">Position 1 (For Homepage 3)</option>
											<option value="position2_home3">Position 2 (For Homepage 3)</option>
										</select>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div id="color-picker" class="input-group tw-picker">
											<input name="bg_color" id="bg_color" type="text" value="#38a677" class="form-control parsley-validated" data-required="true" />
